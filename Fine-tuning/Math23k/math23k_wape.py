...
#encoder.load_state_dict(torch.load("models/encoder_98"))
#predict.load_state_dict(torch.load("models/predict_98"))
#generate.load_state_dict(torch.load("models/generate_98"))
#merge.load_state_dict(torch.load("models/merge_98"))
