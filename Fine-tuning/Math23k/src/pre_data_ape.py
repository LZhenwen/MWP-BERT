...
def transfer_num(data):  # transfer num into "NUM"
    id_list = []
    voc = ['+', '-', '*', '/', '(', ')','^', '1', '3.14', '2', 'N0', 'N1', 'N2', 'N3', 'N4', 'N5', 'N6', 'N7', 'N8', 'N9', 'N10', 'N11', 'N12', 'N13']
    ...
    for idx, d in enumerate(data):
        ...
        if len(input_seq) > 120 or len(out_seq) > 20 or len(out_seq) == 1:
            continue
        flag = False
        #print(out_seq)
    ...
    for g in generate_nums:
        if generate_nums_dict[g] >= 5:
            temp_g.append(g)
    return pairs, temp_g, copy_nums, id_list
