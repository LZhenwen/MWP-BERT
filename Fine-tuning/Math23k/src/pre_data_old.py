...
def prepare_data(pairs_trained, pairs_tested, pairs_tested_ape, trim_min_count, generate_nums, copy_nums, tree=False):
    ...
    for pair in pairs_tested:
        ...
        # train_pairs.append((input_cell, len(input_cell), output_cell, len(output_cell),
        #                     pair[2], pair[3], num_stack, pair[4]))
        test_pairs_ape.append((input_cell, len(input_cell), output_cell, len(output_cell),
                           pair[2], pair[3], num_stack, 0))
    print('Number of testing data %d for 23k' % (len(test_pairs_ape)))
    for pair in pairs_tested_ape:
        ...
        test_pairs.append((input_cell, len(input_cell), output_cell, len(output_cell),
                           pair[2], pair[3], num_stack, 0))
    print('Number of testing data %d for ape' % (len(test_pairs)))
